    ...
    Selectpicker.prototype = {
        ...
        createLi: function() {
            ...
            this.$element.find('option').each(function() {
                ...
                var subtext = $this.data('subtext') !== undefined ? '<small style="background:' + $this.data('subtext') + '" class="muted text-muted"></small>' : '';
                ...
                if (!$this.data('content')) {
                    ...
                    text = icon + '<span 1 class="text">' + text + subtext + '</span>';
                }
                ...
                if (that.options.hideDisabled && ($this.is(':disabled') || $this.parent().is(':disabled'))) {
                    ...
                    if ($this.index() === 0) {
                        ...
                        var labelSubtext = $this.parent().data('subtext') !== undefined ? '<small 2 class="muted text-muted">' + $this.parent().data('subtext') + '</small>' : '';
                        var labelIcon = $this.parent().data('icon') ? '<i class="' + $this.parent().data('icon') + '"></i> ' : '';
                        label = labelIcon + '<span 2 class="text">' + label + labelSubtext + '</span>';
        ...
        render: function() {
            ...
            var selectedItems = this.$element.find('option:selected').map(function() {
                ...
                if (that.options.showSubtext && $this.attr('data-subtext') && !that.multiple) {
                    subtext = ' <small 3 class="muted text-muted">' + $this.data('subtext') + '</small>';
                } else {
                    subtext = '';
                }
