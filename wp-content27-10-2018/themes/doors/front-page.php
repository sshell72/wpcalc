                                    ...
                                    <div style="padding: 0!important; margin: 0 15px !important;" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
										...
										<div class="col-xs-6 col-sm-12">
												<div id="painting" class="panel panel-default">
													<div id='112' class="panel-body" style="overflow:hidden;">
													<!--	<h4>Окраска:</h4>
														<label>Решетки:</label>
											...
											<div class="col-xs-12">
                                                ...
                                                <div id='115' class="row row-rec col-xs-12 col-sm-7 col-md-7 col-lg-9">
                    ...
                    <div class="tab-content">
                            <div class="tab-pane active" id="result">
                                ...
                                <div class="calculate" style="display: none;">
                                    ...
                                    <button type="button" class="btn btn-default info" data-toggle="tooltip" data-placement="top" data-trigger="manual" title="Данная стоимость содержит базовую стоимость двери, всех выбранных доп. опций и предоставляемых услуг"></button>
