...
if(isset($_GET['series_id'])){
    ...
    if(!empty($parameters)) {
        ...
        foreach ($parameters as $parameter) {
            ...
            $added_param = '';
            if (strripos($parameter_type->type, 'список') || strripos($parameter_type->type, 'выбор')) {
...
<form class="street-container" method="POST">
    ...
    <br><br>
	<label for="coeff">Повышающий коэффициент:</label>
	<input type="text" name="coeff" id="coeff" value="<?php echo $coeff; ?>"/>
	<br>
	<label for="coeff">Описание серии:</label>
